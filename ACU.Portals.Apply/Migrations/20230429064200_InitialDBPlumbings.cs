...
namespace ACU.Portals.Apply.Migrations
{
    /// <inheritdoc />
    public partial class InitialDBPlumbings : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUpload", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryState", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Institution = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    StudentDetailsId = table.Column<long>(type: "bigint", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatorId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    LastModificationTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci")
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AcademicDetails_StudentDetails_StudentDetailsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AddressDetails_StudentDetails_StudentDetailsId",
                        column: x => x.StudentDetailsId,
                        principalTable: "StudentDetails",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Denomination = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    ParentEmail = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PhysicalDisability = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NatureofDisability = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    StudentDetailsId = table.Column<long>(type: "bigint", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatorId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtraStudentDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExtraStudentDetails_StudentDetails_StudentDetailsId",
                        column: x => x.StudentDetailsId,
                        principalTable: "StudentDetails",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentApplication_StudentDetails_StudentDetailsId",
                        column: x => x.StudentDetailsId,
                        principalTable: "StudentDetails",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CountryStateId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LGA_CountryState_CountryStateId",
                        column: x => x.CountryStateId,
                        principalTable: "CountryState",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LGA_Country_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Country",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AcademicDetails_StudentDetailsId",
                table: "AcademicDetails",
                column: "StudentDetailsId");

            migrationBuilder.CreateIndex(
                name: "IX_AddressDetails_StudentDetailsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExtraStudentDetails_StudentDetailsId",
                table: "ExtraStudentDetails",
                column: "StudentDetailsId");

            migrationBuilder.CreateIndex(
                name: "IX_LGA_CountryId",
                table: "LGA",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_LGA_CountryStateId",
                table: "LGA",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentApplication_StudentDetailsId",
